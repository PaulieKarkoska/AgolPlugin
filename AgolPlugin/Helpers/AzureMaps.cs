...
namespace AgolPlugin.Helpers
{
    ...
    /// </summary>
    public static class AzureTileMath
    {
        ...
        public static string[] GetQuadkeysInBoundingBox(double[] bounds, int zoom, int tileSize)
        {
            ...
            {
                PositionToTileXY(new double[] { bounds[0], bounds[3] }, zoom, tileSize, out int tlX, out int tlY);
                PositionToTileXY(new double[] { bounds[2], bounds[1] }, zoom, tileSize, out int brX, out int brY);
